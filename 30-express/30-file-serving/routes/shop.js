...
router.get("/", (req, res, next) => {
  ...
  //   - For CommonJS, you can use `_dirname` instead, which is a global var provided by NodeJS to point to the CURRENT MODULE's path in the OS.
  ...
  //      - Note that this is a *URL* and NOT a valid file NodeJS path name. Just use the `fileURLToPath` function to transform it into a valid one (this will also take into account different OS's path encoding): fileURLToPath(import.meta.url)
